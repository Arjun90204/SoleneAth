        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-transparent border border-white/20 text-white rounded focus:border-emerald-400 focus:outline-none transition-colors pr-12"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-white text-black text-[11px] font-bold tracking-[0.15em] uppercase hover:bg-emerald-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <Link
                ...
                className="font-bold text-white hover:text-emerald-400 ml-2 transition-colors"
              >
        ...
        <div className="relative h-full flex items-end p-12">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-lg">
              Premium athleisure engineered for peak performance.
            </p>
          </div>
        </div>
      </div>
