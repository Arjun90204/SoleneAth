  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center pt-16 px-4">
      <div className="max-w-md w-full text-center">
        <div className="w-20 h-20 bg-rose-400/10 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="space-y-4 text-left mb-8">
          ...
          <div className="flex items-start gap-3 p-4 border border-white/10">
            <Package className="w-5 h-5 text-rose-400 flex-shrink-0 mt-0.5" />
            <div>
        ...
        <div className="space-y-3">
          <Link
            to="/orders"
            className="block w-full py-4 bg-white text-black text-[11px] font-bold tracking-[0.15em] uppercase text-center hover:bg-rose-400 transition-colors"
          >
            VIEW ORDERS
          </Link>
          <Link
