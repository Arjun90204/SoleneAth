        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="relative aspect-[3/4] bg-gray-900 overflow-hidden">
              ...
              {product.compare_at_price && (
                <span className="absolute top-4 left-4 bg-emerald-400 text-black text-[10px] font-bold tracking-[0.1em] px-2 py-1">
                ...
                {product.images.map((img, i) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-colors ${
                      i === currentImageIndex ? 'border-emerald-400' : 'border-transparent hover:border-white/40'
                    }`}
                  >
          ...
          <div className="lg:py-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                {product.featured && (
                  <span className="inline-block text-[10px] font-bold tracking-[0.2em] text-emerald-400 uppercase mb-2">
                    Bestseller
                  </span>
                )}
                ...
                {product.colors.map((color) => (
                  <button
                    ...
                    className={`w-10 h-10 rounded-full border-2 transition-all ${
                      color === selectedColor ? 'ring-2 ring-offset-2 ring-offset-black ring-emerald-400 border-emerald-400' : 'border-white/20 hover:border-white/40'
                    }`}
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full py-4 bg-white text-black text-[11px] font-bold tracking-[0.15em] uppercase hover:bg-emerald-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative"
              >
              ...
              {showAddedMessage && (
                <div className="mt-4 p-4 bg-emerald-400/10 border border-emerald-400/20 flex items-center gap-3 text-emerald-400">
          ...
          <div className="mt-20 pt-12 border-t border-white/10">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link
                ...
                className="hidden md:flex items-center text-[11px] font-bold tracking-[0.15em] text-white hover:text-emerald-400 transition-colors"
              >
